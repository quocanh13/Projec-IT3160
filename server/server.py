...
import numpy as np
from disease_predictor.models.neural_network.neural_network_softmax import predict as nn_predict
from disease_predictor.models.softmax_logistic_regression_new.softmax_logsictic_regression import predict as sft_predict
