...
from disease_predictor.models.neural_network.get_data import test_data, training_data, class_weight
...
res = nn.predict(training_data[0][1])
print(np.mean(np.argmax(res, axis=0) == training_data[0][0]))
